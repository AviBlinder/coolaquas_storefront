                  ...
                  <Popover v-for="category in navigation.categories" :key="category.name" class="flex" v-slot="{ open }">
                    ...
                    leave-to-class="opacity-0">
                      <PopoverPanel class="absolute z-20 top-full inset-x-0 text-sm text-gray-500">
                        ...
                        if we put the shadow on the actual panel it pokes out the top, so we use this shorter element 
              ...
              <form class="mt-4 border-t border-gray-200">
                ...
                class="border-t border-gray-200 px-4 py-6" v-slot="{ open }">
                  <h3 class="-mx-2 -my-3 flow-root">
                    <DisclosureButton class="px-2 py-3 bg-white w-full flex items-center justify-between 
             ...
             <!-- Sort Menu -->
              ...
              enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100"
               ...
               leave-to-class="transform opacity-0 scale-95">
                <MenuItems class="origin-top-right absolute right-0 mt-2 w-40 
                rounded-md shadow-2xl bg-white ring-1 
