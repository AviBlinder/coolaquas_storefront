          ...
          <div class="sm:px-6 lg:px-0">
            <div class="h-screen">
              <div class="absolute inset-0 mx-4">
                <img  class="h-full w-full object-cover" :src="imageEdit" :alt="blok.hero_image[0].alt" />
              ...
              <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <div class="mt-10 max-w-sm mx-auto sm:max-w-none flex justify-center">
                    ...
                    class="flex items-center justify-center px-0 py-2 border border-transparent text-base font-medium rounded-md 
                    shadow-sm text-indigo-700 bg-white hover:bg-amber-300  sm:px-8">
                      {{blok.CTA_1}}
                    </router-link>
                </div>
              </div>
    ...
    computed: {
      imageEdit() {
        ...
        const fitIn = `/fit-in/${width}x${height}/${filter}:format(png)`
          return this.blok.hero_image[0].filename.replace("//a.storyblok.com",`//img2.storyblok.com/${fitIn}`)
